...
@Injectable()
export class RaphaelsPatientsService implements Resolve<any>
{
    private patientsRef;
   ...
   constructor(
    ...
    {
        this.patientsRef = this.db.list<Patient>('patients');
        this.writePatientData(6, 'Connor', 'Cash', '1234567890');
        // this.getPatients();
        this.getContacts();
   }

   public getPatient(patientId) {
    return firebase.database().ref('/patients/'+patientId).once('value').then(function(snapshot) {
...
//       });
    ...
    public writePatientData(patientId, name, type, phone_no) {
    ...
    getContacts(): Promise<any>
    {
        ...
        return firebase.database().ref('/patients').once('value')
